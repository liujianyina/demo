...
public interface BaseService<T> {
     ...
     * @param sql
     */
    Query runSqlForUpdateOrDelete(String sql, Map<String, Object> map);
     ...
     * @return
     */
    Query runSqlForQuery(String sql, Map<String, Object> map, Class clz);
     ...
     * @return
     */
    Query runSqlForQuery(String sql, Map<String, Object> map);
